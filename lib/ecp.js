 ...
 */
var secp224k1_p = [ 0x7FFFE56D, 0x7FFFFFFD, 0x7FFFFFFF, 0x7FFFFFFF, 0x7FFFFFFF, 0x7FFFFFFF, 0x7FFFFFFF, 0x7F ];
var secp224k1_a = [ 0, 0, 0, 0, 0, 0, 0, 0 ];
var secp224k1_G = [
...
var secp224k1_n = [ 0x769FB1F7, 0x15E152E2, 0x4BB18613, 0x000EE746, 0x00000000, 0x00000000, 0x00000000, 0x80 ];

/*
 * Parameters of the secp256k1 elliptic curve, packed into multi-precision
 * integers suitable for use with the preceding functions.
 */
var secp256k1_p = [ 0x7FFFFC2F, 0x7FFFFFFD, 0x7FFFFFFF, 0x7FFFFFFF, 0x7FFFFFFF, 0x7FFFFFFF, 0x7FFFFFFF, 0x7FFFFFFF, 0xFF ];
var secp256k1_a = [ 0, 0, 0, 0, 0, 0, 0, 0, 0 ];
var secp256k1_G = [
...
var secp256k1_n = [ 0x50364141, 0x7FA4BD19, 0x3D2280EE, 0x5576E735, 0x7FFFFFEB, 0x7FFFFFFF, 0x7FFFFFFF, 0x7FFFFFFF, 0xFF ];

module.exports = {
	mpn_pack: mpn_pack,
	mpn_unpack: mpn_unpack,
	mpn_new: mpn_new,
	ecp_pubkey: ecp_pubkey,
	ecp_sign: ecp_sign,
	secp224k1_p: secp224k1_p, secp224k1_a: secp224k1_a, secp224k1_G: secp224k1_G, secp224k1_n: secp224k1_n,
	secp256k1_p: secp256k1_p, secp256k1_a: secp256k1_a, secp256k1_G: secp256k1_G, secp256k1_n: secp256k1_n,
};
